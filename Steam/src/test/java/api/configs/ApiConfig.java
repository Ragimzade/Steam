...
public class ApiConfig {
    ...
    protected static final String USD_CURRENCY_FOR_TODAY = String.format("Rates/145?onDate=%s", DateUtil.getCurrentDate());
    protected static final String USD_CURRENCY_FOR_YESTERDAY = String.format("Rates/145?onDate=%s", DateUtil.getYesterdayDate());
